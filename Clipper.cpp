...
bool ClipperBase::PreserveCollinear()
{
    return m_PreserveCollinear;
}

void ClipperBase::PreserveCollinear(bool value)
{
...
bool Clipper::ReverseSolution()
{
    return m_ReverseOutput;
}

void Clipper::ReverseSolution(bool value)
{
    m_ReverseOutput = value;
}

bool Clipper::StrictlySimple()
{
    return m_StrictSimple;
}

void Clipper::StrictlySimple(bool value)
{
...
bool ClipperLib::operator==(const IntPoint &a, const IntPoint &b)
{
...
clipperException::clipperException(const char* description): m_descr(description)
{
...
const char *clipperException::what() const
{
